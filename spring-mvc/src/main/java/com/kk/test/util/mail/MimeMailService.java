...
public class MimeMailService {
	...
	private static Log logger = LogFactory.getLog(MimeMailService.class);
	 ...
	 * @throws MessagingException
	 */
	private MimeMessageHelper buildMimeMessage(SimpleMailMessage message)
			throws MessagingException {
	 ...
	 */
	private String buildTemplateText(String templatefile,
			Map<String, String> params) throws MessagingException {
		try {

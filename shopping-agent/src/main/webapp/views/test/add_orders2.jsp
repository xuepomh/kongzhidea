		...
		<div class='main'>
			<div class="content-area">
				...
				<div class='specialtopic-config-area'>
					<form id='add_form' action='/shopping-agent/mobile/order/addOrders2' method='post' enctype="multipart/form-data">
						<ul class='topic-content'>
							...
							<li class='group'>
								<label class='fm-label'>user_id</label>
								<input class='fm-input' name='user_id'/>
							</li>
							<li class='group'>
								<label class='fm-label'>receiver_id</label>
								<input class='fm-input' name='receiver_id'/>
							<li class='group'>
								<label class='fm-label'>buyer_id </label>
								<input class='fm-input' name='buyer_id' />
							</li>
							<li class='group'>

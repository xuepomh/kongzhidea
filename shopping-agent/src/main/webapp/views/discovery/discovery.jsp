		...
		<div class='main'>
			<div class="content-area">
				...
				<div class='specialtopic-config-area'>
					<form id='add_form' action='/shopping-agent/mobile/discovery/publish' method='post' enctype="multipart/form-data">
						<ul class='topic-content'>
							...
							<li class='group'>
								<label class='fm-label'>买手ids </label>
								<input class='fm-input' name='buyer_ids' />
							</li>
							<li class='group'>
							...
							<li class='group'>
								<label class='fm-label'>编辑内容  </label>
								<textarea cols="100" rows="50" name="article"></textarea>
							</li>
						</ul>

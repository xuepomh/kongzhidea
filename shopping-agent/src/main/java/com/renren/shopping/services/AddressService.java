...
public class AddressService {
	 ...
	 * @param uid
	 */
	public AddressUser getAddressUserDefault(int uid){
		String hql = "from AddressUser where userId = ? and isDefault = 1";
		List<AddressUser> addresses = addressUserDao.find(hql,uid);
		if(addresses.size() == 0)
			return null;
